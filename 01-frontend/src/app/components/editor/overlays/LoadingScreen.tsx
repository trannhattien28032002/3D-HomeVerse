/**
 * LoadingScreen — màn hình chờ phủ toàn trang khi engine đang khởi tạo.
 *
 * Hiển thị logo, thanh tiến độ (prop `progress` 0–100) và xoay vòng các thông điệp
 * trạng thái (MESSAGES) mỗi 1.2s. Khi `done` = true, phát animation fade-out rồi
...
type Props = {
    /** 0–100 */
    progress: number;
    /** Khi true: phát animation fade-out trước khi unmount */
    done: boolean;
    onFadeOutEnd: () => void;
};
...
export default function LoadingScreen({ progress, done, onFadeOutEnd }: Props) {
    ...
    // Xoay vòng các thông điệp trạng thái
    useEffect(() => {
