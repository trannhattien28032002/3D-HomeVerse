 ...
 * Nới rộng (P1): pan imperative không re-cull tới khi thả chuột (commitPan), nên
 * vùng đệm lớn phủ phần lớn pan ngắn → đồ không "pop-in" khi nhả pan. Pan dài hơn
 * đệm vẫn được commitPan lo nốt.
 */
const CULL_MARGIN_PX = 700;
